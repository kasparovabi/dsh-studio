...
- **Claude Code transcripts** — sessions from `~/.claude/projects` appear in the same list with a Claude Code badge, read-only: this app drives dsh, so they can be browsed but not continued.
